...
class AuthServiceTest {
    ...
    class Register {
        ...
        @Test
        @DisplayName("registers new user and returns pending verification")
        void register_NewUser_ReturnsPending() {
            ...
            doNothing().when(emailService).sendRegistrationCode(anyString(), anyString());

            RegisterPendingDto response = authService.register(req);
