...
class AuthControllerTest {
    ...
    class Register {
        ...
        @Test
        @DisplayName("returns 202 with pending verification on valid registration")
        void register_ValidRequest_Returns202() throws Exception {
            when(authService.register(any(RegisterRequest.class)))
                .thenReturn(new RegisterPendingDto("john@example.com", "Enter the 6-digit code we just emailed to confirm your account.", null));
